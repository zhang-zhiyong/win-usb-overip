...
#ifndef _IPUSB_PROTOCOL_H
#define _IPUSB_PROTOCOL_H
#pragma pack(push,1)
#ifdef __GNUC__
...
#define IPUSB_BUS_ID_SIZE	32
#define IPUSB_DEV_PATH_MAX	256
#define IPUSB_NAME_MAX		64


struct op_devinfo_request {
	char busid[IPUSB_BUS_ID_SIZE];
} __attribute__((packed));
...
struct usb_device {
	char path[IPUSB_DEV_PATH_MAX];
        char busid[IPUSB_BUS_ID_SIZE];
        char vendor_name[IPUSB_NAME_MAX];
...
#define IPUSB_DIR_OUT	0
#define IPUSB_DIR_IN 	1
...
/*
 * All ipusb packets use a common header to keep code simple.
 */
struct ipusb_header {
