...
int ipusb_use_syslog = 0;
int ipusb_use_stderr = 0;
int ipusb_use_debug  = 0;
...
void dump_usb_interface(struct ipusb_usb_interface *uinf)
{
	char buff[100];
...
void dump_usb_device(struct ipusb_usb_device *udev)
{
	char buff[100];
...
int ipusb_names_init(char *f)
{
	return names_init(f);
}

void ipusb_names_free()
{
	names_free();
}
